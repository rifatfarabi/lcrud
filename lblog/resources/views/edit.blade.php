       ...
       <!-- 2 column grid layout with text inputs for the first and last names -->
        <div class="row mb-4">
            ...
            <div class="form-outline mb-4">
                <input type="email" id="form3Example3" class="form-control" value="{{ $student->email }}" name="email" placeholder="E-mail" />
                <label class="form-label" for="form3Example3">Email address</label>
            </div>
        
            <!-- Password input --> 
            <div class="form-outline mb-4">
                <input type="text" name="phone" id="defaultRegisterPhonePassword" class="form-control" value="{{ $student->phone }}" class="phone" placeholder="Phone Number" aria-describedby="defaultRegisterFormPhoneHelpBlock" />
            </div>
